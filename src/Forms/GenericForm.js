...
class GenericForm extends React.Component{
        ...
        return(
            <div className  = 'formdiv' style = {{  color: '#482728'}}>
                ...
                <form onSubmit = {this.handleSubmit}>
                  ...
                  <label>Phone Number:</label> <input type = 'text' className = 'inputtext' name = 'phone' value = {this.state.phone} onChange = {this.handleChange}/><br/>
                  ...
                  <label>Best way and time to contact:</label> <input type = 'text' className = 'inputtext' name = 'bestway' value = {this.state.bestway} onChange = {this.handleChange}/><br/>
                  <label>How did you hear about Pawsibility Dog Training?</label> <input type = 'text' className = 'inputtext' name = 'howhear' value = {this.state.howhear} onChange = {this.handleChange}/><br/>
              
                  <label>What kind of dog(s) do you have? How old are they? Are they spayed/neutered?</label><br/>
                  <textarea rows = '3' cols = '80' name = 'whatkind' value = {this.state.whatkind} onChange = {this.handleChange} /><br/>

                  <label>How long have you had your dog(s)? </label> <input type = 'text' className = 'inputtext' name = 'howlong' value = {this.state.howlong} onChange = {this.handleChange}/><br/>
                  <label>Is your dog crate trained? </label> <input type = 'text' className = 'inputtext' name = 'cratetrained' value = {this.state.cratetrained} onChange = {this.handleChange}/><br/>
 ...
 </label><br/> <textarea rows = '3' cols = '80' name = 'pleaseexplain' value = {this.state.pleaseexplain} onChange = {this.handleChange}/> <br/>
                  <label>Who lives in your household and how old are they? What is their relationship to the dog(s)?
 </label><br/> <textarea rows = '3' cols = '80' name = 'wholives' value = {this.state.wholives} onChange = {this.handleChange}/><br/>
                  <label>Have you ever used a dog trainer/behaviorist/psychologist before? Please share your experiences.
 </label> <br/> <textarea rows = '3' cols = '80' name = 'haveyou' value = {this.state.haveyou} onChange = {this.handleChange}/><br/>
                  <label>Questions/additional information:</label> <br/> <textarea rows = '3' cols = '80' name = 'questions' value = {this.state.questions} onChange = {this.handleChange}/><br/>
